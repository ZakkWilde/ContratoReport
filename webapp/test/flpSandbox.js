		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Contrato Fornecedor Divergente",
									"targetURL": "#zfiorictrfdrep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiorictrfdrep-display": {
								"semanticObject": "zfiorictrfdrep",
								"action": "display",
								"description": "App para exibição dos contratos divergentes ",
								"title": "Contrato Fornecedor Divergente",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiorictrfdrep",
									"url": sap.ui.require.toUrl("zfiorictrfdrep")
								}
							}
						}
					}
